...
from app.models.holo_member import HoloMemberCreate, HoloMemberPublic, HoloMemberUpdate
...
#     holo_3rd_list = [
#         {"id": 1, "type": "3", "name": "兎田ぺこら", "twitter": "https://twitter.com/usadapekora", "age": 111},
#         {"id": 2, "type": "3", "name": "潤羽るしあ", "twitter": "https://twitter.com/uruharushia", "age": 1600},
#         {"id": 3, "type": "3", "name": "不知火フレア", "twitter": "https://twitter.com/shiranuiflare", "age": 221},
#         {"id": 4, "type": "3", "name": "白銀ノエル", "twitter": "https://twitter.com/shiroganenoel", "age": 18},
#         {"id": 5, "type": "3", "name": "宝鐘マリン", "twitter": "https://twitter.com/houshoumarine", "age": 17},
#     ]
...
async def get_all_holo_member(
    holo_member_repo: HoloMemberRepository = Depends(get_repository(HoloMemberRepository))
...
async def create_new_holo_member(
    ...
    created_holo_member = await holo_member_repo.create_holo_member(new_holo_member=new_holo_member)
    return created_holo_member

# get idを元に取得
@router.get("/{id}/", response_model=HoloMemberPublic,
...
# put idを元に更新
@router.put('/{id}/', response_model=HoloMemberPublic,
...
# delete idを元に削除
@router.delete('/{id}/', response_model=int, name='holo_member:delete-holo_member-by-id')
